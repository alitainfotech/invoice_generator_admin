...
const projects = [
  {
    ...
    files: [
      { name: "Invoice Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Invoice Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Invoice Logo.Zip", size: "2.02 MB", link: "#" },
      { name: "Invoice admin.Zip", size: "2.25 MB", link: "#" },
    ],
    comments: [
      {
        id: 1,
